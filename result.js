document.addEventListener('DOMContentLoaded', () => {
    ...
    vaccines.forEach(vaccine => {
        ...
        const appointmentDate = getAppointmentDate(vaccine.name, doseReceived, doseRemaining, ageInDays, vaccinationDate, birthWeight);
...
function getAppointmentDate(vaccineName, doseReceived, doseRemaining, ageInDays, vaccinationDate, birthWeight) {
    let appointmentDate = '';
    ...
    switch (vaccineName) {
        ...
        case 'hbv':
            if (doseRemaining === 1) {
                ...
                } else if (doseRemaining === 0 && ageInDays > 7 && birthWeight >= 2000) {
                    appointmentDate = 'Pas de vaccination';
            }
            break;
        case 'hexap1vpo':
